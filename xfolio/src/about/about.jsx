        ...
        <div className="about-container">
            ...
            <div className="about-grid">
                <div className="about-header">
                    ...
                    <h2>AI & Machine<br />Learning Engineer</h2>
                </div>

                <div className="about-content">
                    <h4>
A highly motivated and results-oriented Computer Science student with a specialization in AI & Machine Learning.Eager to contribute to a dynamic team, solve complex
problems, and drive innovation in a fast-paced environment.
                    </h4>
                  <p>
    As a Computer Science student specializing in AI & Machine Learning, I build end-to-end solutions that solve real-world problems. My experience ranges from developing diagnostic models for healthcare to architecting scalable AI career counselors. I am driven by the challenge of turning innovative ideas into impactful applications.
  </p>
                    <div className="stats-grid">
                        <div className="stat-item">
                            <p className='des2'>PROJECTS DONE</p>
                            <h1>3</h1>
                        </div>
                        <div className="stat-item">
            ...
            <div className="about-image-container">
                <img src={Image2} alt="Rishabh Verma" />
            </div>
